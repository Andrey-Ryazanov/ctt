...
<?php
if (isset($arParams['ADDITIONAL_CUSTOM_LINKS']) && $arParams['ADDITIONAL_CUSTOM_LINKS'])
{?>

    <?foreach ($arParams['ADDITIONAL_CUSTOM_LINKS'] as $key => $value):?>
        <div class="photo_gallery only_link">
            <h3 class="open_fancy">
                <a href="<?=$value?>"><?=$key?></a>
            </h3>
        </div>
