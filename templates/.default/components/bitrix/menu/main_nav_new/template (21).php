                        ...
                        <?if ($arItem["PARAMS"]["no_wrap"] != "y") {?>
                            <div class="wrap_sub_nav">
                                <div class="sub_nav_1">
                                    ...
                                    $i = 0;
                                    $flag = false;
                                    if ($arItem["TEXT"] == "_О выставке" || $arItem["TEXT"] == "_Участникам" || $arItem["TEXT"] == "_Trade fair" || $arItem["TEXT"] == "Exhibitors" || $arItem["TEXT"] == "Журналистам" || $arItem["TEXT"] == "_Press") {
                                        $flag = true;
                                    }
                                    ...
                                    <?foreach($arResult["MENU"]['level2'][$arItem['TEXT']] as $k => $arItem2){?>
                                        ...
                                        <?}?>
                                        <div class="sub_item_1" <?if($arItem2["TEXT"]=="Специальные форматы участия"){?>style="margin-top: -190px;"<?}?> <?if($arItem2["TEXT"]=="Фото выставки"){?>style="margin-top: -45px;"<?}?> <?if($arItem2["TEXT"]=="Партнеры"){?>style="margin-top: -72px;"<?}?>>
                                            ...
                                            <div class="sub_nav_2">
                                               ...
                                               <?if($arItem["TEXT"] == "_О выставке") {
                                                ?>
                                                    ...
                                                    <div class="sub_item_1" <?if($arResult["MENU"]['level2'][$arItem['TEXT']][$ind[1]]["TEXT"]=="Специальные форматы участия"){?>style="margin-top: -190px;"<?}?> <?if($arResult["MENU"]['level2'][$arItem['TEXT']][$ind[1]]["TEXT"]=="Фото выставки"){?>style="margin-top: -45px;"<?}?> <?if($arResult["MENU"]['level2'][$arItem['TEXT']][$ind[1]]["TEXT"]=="Партнеры"){?>style="margin-top: -72px;"<?}?> id="0">
                                        ...
                                        <?if ($flag) {
                                            ...
                                            while (($c+1) != count($arResult["MENU"]['level2'][$arItem['TEXT']])) {
                                                ...
                                                <div class="sub_item_1" <?if($arResult["MENU"]['level2'][$arItem['TEXT']][$ind[$c]]["TEXT"]=="Специальные форматы участия"){?>style="margin-top: -190px;"<?}?> <?if($arResult["MENU"]['level2'][$arItem['TEXT']][$ind[$c]]["TEXT"]=="Фото выставки"){?>style="margin-top: -45px;"<?}?> <?if($arResult["MENU"]['level2'][$arItem['TEXT']][$ind[$c]]["TEXT"]=="Партнеры"){?>style="margin-top: -72px;"<?}?> id="<?=$c?>">
                            ...
                            <div class="sub_nav_1">
                                ...
                                <?foreach($arResult["MENU"]['level2'][$arItem['TEXT']] as $k => $arItem2){?>
                                    <?if ($i == 1) {?>
                                        <div class="sub_nav_1 r">
                                    <?}?>
                                    <div class="sub_item_1" <?if($arItem2["TEXT"]=="Photo gallery"){?>style="margin-top: -25px;"<?}?> <?if($arItem2["TEXT"]=="Partnership opportunities"){?>style="margin-top: -50px;"<?}?> <?if($arItem2["TEXT"]=="Partners"){?>style="margin-top: -115px;"<?}?> <?if($arItem2["TEXT"]=="Специальные форматы участия"){?>style="margin-top: -190px;"<?}?> <?if($arItem2["TEXT"]=="Фото выставки"){?>style="margin-top: -45px;"<?}?> <?if($arItem2["TEXT"]=="Партнеры"){?>style="margin-top: -72px;"<?}?>>
                                        <a class="sub_link_1 <?if (!$arItem2['LINK']) {?> not_h <?}?> <?if ($i == 0) {?>nh<?}?>" <?if ($arItem2['LINK']) {?>href="<?=$arItem2['LINK']?>"<?}?>><?=$arItem2['TEXT']?><span></span></a>
                                        <div class="sub_nav_2">
                                            <?$admin_key = 0?>
                                            <?foreach ($arItem2["PARAMS"] as $arName => $arLink) {?>
                                    ...
                                    <?if ($flag) {
                                        ...
                                        <?while (($c+1) != count($arResult["MENU"]['level2'][$arItem['TEXT']])) {?>
                                            ...
                                            <div class="sub_item_1" <?if($arResult["MENU"]['level2'][$arItem['TEXT']][$ind[$c]]["TEXT"]=="Photo gallery"){?>style="margin-top: -25px;"<?}?> <?if($arResult["MENU"]['level2'][$arItem['TEXT']][$ind[$c]]["TEXT"]=="Partnership opportunities"){?>style="margin-top: -50px;"<?}?> <?if($arResult["MENU"]['level2'][$arItem['TEXT']][$ind[$c]]["TEXT"]=="Partners"){?>style="margin-top: -115px;"<?}?> <?if($arResult["MENU"]['level2'][$arItem['TEXT']][$ind[$c]]["TEXT"]=="Специальные форматы участия"){?>style="margin-top: -190px;"<?}?> <?if($arResult["MENU"]['level2'][$arItem['TEXT']][$ind[$c]]["TEXT"]=="Фото выставки"){?>style="margin-top: -45px;"<?}?> <?if($arResult["MENU"]['level2'][$arItem['TEXT']][$ind[$c]]["TEXT"]=="Партнеры"){?>style="margin-top: -72px;"<?}?> id="<?=$c?>">
                                                <a class="sub_link_1 <?if (!$arResult["MENU"]['level2'][$arItem['TEXT']][$ind[$c]]["LINK"]) {?>not_h<?}?>" <?if ($arResult["MENU"]['level2'][$arItem['TEXT']][$ind[$c]]["LINK"]) {?>href="<?=$arResult["MENU"]['level2'][$arItem['TEXT']][$ind[$c]]["LINK"]?>"<?}?>><?=$arResult["MENU"]['level2'][$arItem['TEXT']][$ind[$c]]["TEXT"]?><span></span></a>
                                                <div class="sub_nav_2">
                                                    <?$admin_key_2 = 0?>
                                                    <?foreach ($arResult["MENU"]['level2'][$arItem['TEXT']][$ind[$c]]["PARAMS"] as $arName => $arLink) {?>
