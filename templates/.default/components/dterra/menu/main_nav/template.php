                        ...
                        <div class="sub_nav_1">
                            ...
                            <?foreach($arResult["MENU"]['level2'][$arItem['TEXT']] as $arItem2){?>
                                <div class="sub_item_1">
                                    <a class="sub_link_1" href="<?=$arItem2['LINK']?>"><?=$arItem2['TEXT']?><span></span></a>
                                    <div class="sub_nav_2">
                                        <!--<a class="arr_back" href="#">Назад</a>-->
                                                    ...
                                                    <div class="sub_nav_3">
                                                        ...
                                                        <?foreach($arResult["MENU"]['level4'][$arItem3['TEXT']] as $arItem4){?>
                                                            <div class="sub_item_3">
                                                                <a class="sub_link_3" href="<?=$arItem4['LINK']?>"><?=$arItem4['TEXT']?><?if($arResult["MENU"]['level5'][$arItem3['TEXT']]){?>
                                                <span></span><?}?></a>
				                                                <?if($arResult["MENU"]['level5'][$arItem4['TEXT']]){?>
				                                                    <div class="sub_nav_3">
				                                                        ...
				                                                        <?foreach($arResult["MENU"]['level5'][$arItem4['TEXT']] as $arItem5){?>
				                                                            <div class="sub_item_3">
				                                                                <a class="sub_link_3" href="<?=$arItem5['LINK']?>"><?=$arItem5['TEXT']?></a>
				                                                            </div>
				                                                        <?}?>
				                                                    </div>
				                                                <?}?>
